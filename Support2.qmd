...
Scelta del numero ragionevole di componenti
```{r}
...
applicazione di CLUSPCA
```{r}
res_cluspca <- num_data_red |> 
...
```{r}
ggpairs(num_data_scaled |> select(hrt, meanbp, temp))
```

##RUNNA TU
GMM feature selection 
```{r}
set.seed(123)  
