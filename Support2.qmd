...
3) Ripete finché converge o raggiunge il limite di iterazioni.
Funziona bene con variabili miste (numeriche e categoriche) e non richiede assunzioni parametriche.
...
## 👎 RKM (DA FARE tuning per ndim e nclus)
...
## ✅Kmeans
Variabili che agiscono con maggiore intensità sulla prima componente, la quale sembra discriminare due gruppi
...
# Metodo supervisionato cluster ~ dimensioni fattoriali MCA (prime 3)
...
# Metodo supervisionato cluster ~ meanbp, hrt, temp (prime 3 variabili discriminanti)
